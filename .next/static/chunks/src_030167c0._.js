...
;
;
const CLICK_EFFECT_DURATION = 400; // in milliseconds
function CursorEffect() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CursorEffect.useEffect": ()=>{
            const handleClick = {
                "CursorEffect.useEffect.handleClick": (e)=>{
                    const newEffect = {
                        id: Date.now(),
                        x: e.clientX,
                        y: e.clientY
                    ...
                    setEffects({
                        "CursorEffect.useEffect.handleClick": (prev)=>[
                                ...prev,
                                newEffect
                            ]
                    }["CursorEffect.useEffect.handleClick"]);
                    // Remove the effect after the animation duration
                    setTimeout({
                        "CursorEffect.useEffect.handleClick": ()=>{
                            setEffects({
                                "CursorEffect.useEffect.handleClick": (prev)=>prev.filter({
                                        "CursorEffect.useEffect.handleClick": (effect)=>effect.id !== newEffect.id
                                    }["CursorEffect.useEffect.handleClick"])
                            }["CursorEffect.useEffect.handleClick"]);
                        }
                    }["CursorEffect.useEffect.handleClick"], CLICK_EFFECT_DURATION);
                }
            }["CursorEffect.useEffect.handleClick"];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            effects.map((effect)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    style: {
                        transform: `translate(${effect.x}px, ${effect.y}px)`
                    },
                    className: "jsx-eeb61a1e646675f1" + " " + "pointer-events-none fixed inset-0 z-[999]",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            width: '50px',
                            height: '50px',
                            background: 'radial-gradient(circle, hsla(var(--primary), 0.7) 0%, hsla(var(--primary), 0) 70%)',
                            animation: `click-burst ${CLICK_EFFECT_DURATION}ms ease-out forwards`
                        },
                        className: "jsx-eeb61a1e646675f1" + " " + "absolute -translate-x-1/2 -translate-y-1/2 rounded-full"
                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "eeb61a1e646675f1",
                children: "@keyframes click-burst{0%{opacity:1;transform:scale(0)}80%{opacity:.8}to{opacity:0;transform:scale(1.5)}}"
            }, void 0, false, void 0, this)
        ]
    }, void 0, true);
}
_s(CursorEffect, "QXI84vjS251t5feTBtWEq6Gf18I=");
_c = CursorEffect;
var _c;
...
//# sourceMappingURL=src_030167c0._.js.map